namespace Fracter2.View
{
	partial class VeroniAppCtl
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolStrip1.Items.AddRange( new System.Windows.Forms.ToolStripItem[] {this.AddLayerDropDownButton} );
			...
			this.AddLayerDropDownButton.DropDownItems.AddRange( new System.Windows.Forms.ToolStripItem[] {this.PointEditorToolStripMenuItem} );
